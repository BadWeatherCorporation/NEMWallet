function ItalianProvider($translateProvider) {
    ...
    $translateProvider.translations('it', {
        ...
        DASHBOARD_NOTICE_1: 'Benvenuto in NEM Cold Wallet Beta!',
        DASHBOARD_NOTICE_2: 'Prego <a href="https://github.com/bad-weather-corp/NEMWallet" target="_blank">segnalare problemi qui</a>.',
        DASHBOARD_NOTICE_3: 'Il team NEM suggerisce di testare prima su TestNet per familiarizzare con NEM Cold Wallet prima di utilizzare la rete principale MainNet. Una guida semplice può essere trovata <a href="https://blog.nem.io/nanowallet-tutorial/" target="_blank">qui</a>. Gli utenti sono responsabili della sicurezza dei fondi e del mantenimento di un backup sicuro di tutte le proprie chiavi private.Il team NEM non è responsabile per eventuali perdite di fondi dovute a un uso improprio di questa applicazione sulla rete principale (MainNet).',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Mi dispiace, ma con questo browser non è possibile utilizzare NEM Cold Wallet in modo sicuro ...',
        ...
        FAQ_QUESTION_1: 'Come funziona NEM Cold Wallet?',
        ...
        FAQ_ANSWER_4: 'L"attuale mappa di sviluppo include l"integrazione di tutte le funzionalità di NEM Cold Wallet v1.x.x e il completamento di progetti finanziati dalla comunità per lavorare attraverso questo portfolio.',
