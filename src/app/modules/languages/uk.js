function UkrainianProvider($translateProvider) {
    ...
    $translateProvider.translations('uk', {
        ...
        DASHBOARD_NOTICE_1: 'Вітаємо у NEM Cold Wallet Beta!',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Вибачте, але користування NEM Cold Wallet у цьому браузері небезпечно...',
        ...
        FAQ_QUESTION_1: 'Як працює гаманець NEM Cold Wallet?',
        FAQ_ANSWER_1: 'NEM Cold Wallet побудований з використанням криптографічних бібліотек на AngularJS та ES6. Це самодостатній клієнтський додаток, який ніколи не надсилає жодних конфіденційних даних до мережі; всі дії відбуваються всередені Вашого браузера: від створення приватних ключів до підписання транзакцій.',
        ...
        FAQ_ANSWER_4: 'Поточна дорожня карта розвитку включає інтеграцію усіх функцій з гаманця NEM Cold Wallet v1.x.x та завершення проектів, що фінансуються спільнотою, для роботи через цей гаманець.',
