function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        DASHBOARD_NOTICE_1: 'Welkom bij NEM Cold Wallet!',
        DASHBOARD_NOTICE_2: '<a href="https://github.com/bad-weather-corp/NEMWallet" target="_blank">Meldt hier problemen</a>.',
        DASHBOARD_NOTICE_3: 'Het NEM-team adviseert je om eerst op het Testnet vertrouwd te raken met NEM Cold Wallet voordat je het Mainnet gaat gebruiken. Een eenvoudige gids vindt je <a href="https://blog.nem.io/nanowallet-tutorial/" target="_blank"> hier</a>. Gebruikers zijn zelf verantwoordelijk voor hun geld en moeten zelf van de persoonlijke sleutels een back-up maken. Het NEM-team is niet verantwoordelijk voor het verlies van geld door deze applicatie op het Mainnet te gebruiken.',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Sorry, je kan NEM Cold Wallet niet veilig gebruiken met deze browser...',
	...
	PORTAL_APOSTILLE_BTN_2: 'Verifieer',
 	...
 	PORTAL_SIGNED_MSG_TEXT: 'Creëer en verifieer een ondertekend bericht om het accounteigendom te verifiëren zonder transacties uit te voeren.',
        ...
        FAQ_QUESTION_1: 'Hoe werkt NEM Cold Wallet?',
        FAQ_ANSWER_1: 'NEM Cold Wallet is gebouwd met behulp van de nieuwste cryptobibliotheken met ES6 en AngularJS. Het is een volledige client-applicatie die nooit gevoelige gegevens verzendt; Alles gebeurt in je browser m.b.t. het creëren van persoonlijke sleutels voor het ondertekenen van transacties.',
