function SpanishProvider($translateProvider) {
    ...
    $translateProvider.translations('es', {
        ...
        DASHBOARD_NOTICE_1: 'Bienvenido(a) a la NEM Cold Wallet Beta!',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Disculpa, pero no puedes usar NEM Cold Wallet de forma segura con este explorador...',
        ...
        FAQ_QUESTION_1: '¿Cómo funciona la NEM Cold Wallet?',
        FAQ_ANSWER_1: 'NEM Cold Wallet está construida con AngularJS and ES6. Es una aplicación completa del lado del cliente que nunca envía ningún dato sensible de forma insegura a través de la red; Todo sucede en tu navegador, desde la creación de claves privadas hasta la firma de transacciones.',
        ...
        FAQ_ANSWER_4: 'La hoja de ruta actual incluye integración de todas las características de NEM Cold Wallet v1.x.x y la finalización de proyectos financiados por la comunidad para trabajar a través de esta cartera.',
