function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        DASHBOARD_NOTICE_1: 'Добро пожаловать в NEM Cold Wallet Beta!',
        DASHBOARD_NOTICE_2: 'Пожалуйста, <a href="https://github.com/bad-weather-corp/NEMWallet" target="_blank">сообщите об ошибке.</a>',
        DASHBOARD_NOTICE_3: 'Команда NEM не несёт ответственности за любые потери средств, в связи с использованием NEM Cold Wallet в главной сети (mainnet). Мы рекомендуем, в первую очередь, ознакомиться с NEM Cold Wallet в тестовой сети (testnet). Пользователи несут ответственность за сохранность своих средств, резервных копий и закрытых ключей.',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Простите, но Вы не можете безопасно использовать NEM Cold Wallet в этом браузере...',
        ...
        ACCOUNT_HARVESTING_NOTE: 'Если Вы уже запускали сбор блоков <b>используя NEM Cold Wallet</b> и Ваше локальное хранилище было очищено, выберите узел, который использовался, для восстановления прежнего состояния. (Ваш сбор блоков не останавливался).',
        ...
        FAQ_ANSWER_1: 'NEM Cold Wallet is built using the latest crypto libraries with ES6 and AngularJS. It is a full client-side application that never sends any sensitive data through the wire; everything happens in your browser from creating private keys to the signing of transactions.',
