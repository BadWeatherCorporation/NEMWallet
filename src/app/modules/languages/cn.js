function ChineseProvider($translateProvider) {
    ...
    $translateProvider.translations('cn', {
        ...
        DASHBOARD_NOTICE_1:  '欢迎来到 NEM Cold Wallet Beta!',
        DASHBOARD_NOTICE_2: '请 <a href="https://github.com/bad-weather-corp/NEMWallet" target="_blank">在这里报告问题</a>',
        DASHBOARD_NOTICE_3: 'NEM team 不对由于在主网上使用此应用程序而导致的任何资金损失负责，以及我们建议您首先在测试网上进行测试，以便先熟悉NEM Cold Wallet. 用户自己负责其资金并具有其私钥。.',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: '对不起，但你不能在这里安全地使用NEM Cold Wallet...',
