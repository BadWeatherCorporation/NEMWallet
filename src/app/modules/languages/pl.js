function PolishProvider($translateProvider) {
    ...
    $translateProvider.translations('pl', {
        ...
        DASHBOARD_NOTICE_1: 'Witamy w NEM Cold Wallet Beta!',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Przykro nam, ale nie możesz bezpiecznie użyć NEM Cold Wallet\'a za pomocą tej przeglądarki...',
        ...
        ACCOUNT_HARVESTING_NOTE: 'Jeśli zbierałeś bloki <b>używając NEM Cold Wallet</b> i twoja lokalna pamięć została wykasowana, wybierz serwer, którego używałeś, aby przywrócić stan aplikacji. (Twoje zbieranie nie zatrzymało się).',
        ...
        FAQ_QUESTION_1: 'Jak działa Portfel NEM Cold Wallet ?',
        FAQ_ANSWER_1: 'Portfel NEM Cold Wallet jest zbudowany przy użyciu najnowszych bibliotek z ES6 i AngularJS. To aplikacja client-side , nidgy nie wysyła wrażliwych danych; wszystko dzieje się w przeglądarce od tworzenia kluczy prywatnych do podpisywania transakcji.',
        ...
        FAQ_ANSWER_4: 'Bieżący plan to zintegrowanie z portfelem NEM Cold Wallet wszystkich funkcji klienta NEM i projektów finansowanych przez społeczność.',
