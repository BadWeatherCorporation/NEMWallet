function PortugueseBRProvider($translateProvider) {
    ...
    $translateProvider.translations('ptbr', {
        ...
        DASHBOARD_NOTICE_1: 'Bem vindo a NEM Cold Wallet Beta!',
        DASHBOARD_NOTICE_2: 'Por favor <a href="https://github.com/bad-weather-corp/NEMWallet" target="_blank">reporte problemas aqui</a>.',
        DASHBOARD_NOTICE_3: 'O time da NEM sugere que você faça testes primeiramente na TestNet para familiarizar-se com a NEM Cold Wallet, antes de utilizar a rede principal MainNet. Um guia simples pode ser encontrado <a href="https://blog.nem.io/nanowallet-tutorial/" target="_blank">aqui</a>. Os usuários são responsáveis pela segurança de seus fundos e por manter um backup seguro de todas as suas chaves privadas. O time da NEM não é responsável por nenhuma perda de fundos pelo uso indevido deste aplicativo na rede principal (MainNet).',
        ...
        // HOME MODULE
        HOME_UNSUPPORTED_BROWSER: 'Sinto muito, mas você não pode usar a NEM Cold Wallet de forma segura com este navegador...',
        ...
        FAQ_QUESTION_1: 'Como a NEM Cold Wallet funciona?',
        FAQ_ANSWER_1: 'A NEM Cold Wallet é feita com AngularJS e ES6. É um aplicativo que funciona totalmente do lado do cliente e nunca envia nenhuma informação sensível através dos cabos; tudo acontece no seu navegador local, desde criar as chaves privadas até a assinatura das transações.',
        ...
        FAQ_ANSWER_4: 'O atual mapa de desenvolvimento inclui integração de todos os recursos da NEM Cold Wallet v1.x.x e a conclusão de projetos financiados pela comunidade para trabalhar através desta carteira.',
        ...
        FAQ_ANSWER_9: 'É altamente recomendável que sempre armazene suas chaves privadas em papel. <br> Você pode imprimí-las e arquivá-las em algum lugar seguro. <br><br> No que diz respeito aos arquivos de carteira, você sempre deve manter várias cópias em diferentes locais a frio (desconectados), como cartões usb. <br> Senhas devem ser únicas e complexas, por esta razão, sempre escreva-a primeiro. <br><br> Quando você desejar verificar a sua carteira ou realizar operações:<br> - Conecte o seu cartão usb <br> - Importe sua carteira para a NEM Cold Wallet<br> - Desconecte o seu cartão usb.<br><br> Uma cópia da sua carteira ficará armazenada no armazenamento local para o momento que você precisar.<br> Assim que terminar, saia e remova as carteiras do seu armazenamento local com o botão de exclusão ao lado direito da barra do rodapé da página.',
